...
//        LVRef<ldomXRange> page = ui->view->getDocView()->getPageDocumentRange(-1) ;
//        if ( !page.isNull() )
//        {
//            // search for links
...
//                    : _list(list) { nelem = 0; ntext = 0 ; y0 = -1 ; nchi = 0 ; }
//                /// called for each found text fragment in range
//                virtual void onText( ldomXRange * tx )
//                {
//                    lvRect rect ;
//                    ++ntext ;
//                    rect.clear();
...
//                    ldomXPointerEx startnode = tx->getStart() ;
//                    /***
//                    ldomXPointerEx *pchi ;
//                    for (nchi = 0, pchi=startnode.firstChild(); pchi != NULL; nchi++)
//                    {
//                        ++nchi ;
//                        if (pchi->lastChild())
//                            break ;
//                        else
//                            pchi = pchi->child(nchi) ;
//                    }
//                    ***/

//                    qDebug("tx%d/%d: %d,%d -- %d,%d", ntext, nchi, rect.left, rect.top-y0, rect.right, rect.bottom-y0) ;
//                    //void (*walker)(ldomXPointerEx &) = this->elemwalker ;
//                    startnode.recurseNodes(elemwalker) ;
//                }
...
//                    ***/
//                    ++nelem ;
//                    qDebug("%d: lev=%d, idx=%d, name=%s, id=%d", nelem, elem->getNodeLevel(), elem->getNodeIndex(),
//                           UnicodeToUtf8(elem->getNodeName()).c_str(),
//                           elem->getNodeId()) ;
//                    _list.add( new ldomXRange(elem) );
//                    return true;
//                }
...
//bool MainWindow::kbIvent(QWSKeyEvent *pke)
//{
//		if(ui->view->isWordSelection()) {
//				return ui->view->kbIvent(pke);
//		}
...
////			case Qt::Key_D:
////			{
////				ui->view->startWordSelection();
////				return true;
////			}
//						default:
//								qDebug("MainWindow: QWS key: key=%d, press=%d, uni=%d", pke->simpleData.keycode,
